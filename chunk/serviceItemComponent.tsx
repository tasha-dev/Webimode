...
export default function ServiceItemComponent({children, icon, img, title, hasButtons = false, hasMobileImageInLeft = false, iconGradiant}:propsType):ReactNode {
    ...
    return (
        <div className="lg:h-[528px] h-[555px] overflow-hidden rounded-[40px] relative group">
            ...
            <div className={`h-full w-full absolute top-0 left-0 bg-dark/50 p-[44px] flex ${(hasMobileImageInLeft) ? 'lg:flex-row flex-col gap-[20px] lg:justify-between lg:items-end items-center' : 'flex-col justify-end items-start'}`}>
                {
                    (!hasMobileImageInLeft)
                        ? (
                            ...
                            <div className="lg:w-[60%] w-full lg:h-auto h-full flex flex-col lg:items-end lg:justify-start justify-end">
                                <div>
                                    <div data-gradiant={iconGradiant} className="bg-gradient-to-br w-[56px] h-[56px] aspect-auto flex justify-center items-center mb-[12px] rounded-[12px] text-white data-[gradiant='blue']:from-lightTheme data-[gradiant='blue']:to-themeBlue data-[gradiant='green']:from-frogGreen data-[gradiant='green']:to-theme data-[gradiant='purple']:from-themePurple data-[gradiant='purple']:to-themeBlue data-[gradiant='orange']:from-lightOrange data-[gradiant='orange']:to-orange data-[gradiant='deep-green']:from-darkFrogGreen data-[gradiant='deep-green']:to-frogGreen data-[gradiant='pink']:from-pink data-[gradiant='pink']:to-themePurple data-[gradiant='reversed-pink']:from-themePurple data-[gradiant='reversed-pink']:to-pink data-[gradiant='dark-blue']:from-themeBlue data-[gradiant='dark-blue']:to-lightTheme lg:mx-0 mx-auto">
                                        {
                                            (icon === 'design')
                ...
                }
                {
                    (hasMobileImageInLeft)
                        ? (
                            <>
                                <div className="xl:block hidden relative transition-all duration-500 top-0 left-0 w-[40%] h-full group-hover:absolute group-hover:w-full">
                                    <div className="skewed-right transition-all duration-500 rounded-[20px] overflow-hidden absolute left-0 top-0 h-full w-full shadow-black group-hover:w-[50%] group-hover:rounded-[0]">
                                        <div className="absolute transition-all duration-500 w-full h-full top-0 left-0 bg-lightGrey group-hover:rounded-0" />
                                    </div>
                                    <div className="skewed-right transition-all duration-500 rounded-[20px] overflow-hidden absolute left-[20px] top-0 h-full w-full group-hover:right-0 group-hover:left-auto group-hover:w-[50%] group-hover:rounded-[0]">
                                        <div className="absolute transition-all duration-500 rounded-[20px] w-[85%] h-[85%] right-0 -translate-y-[50%] bg-white shadow-black group-hover:w-full group-hover:h-full group-hover:top-0 top-[50%] group-hover:translate-y-0 group-hover:rounded-[0] group-hover:bg-lightGrey" />
                                    </div>
                                </div>
                                <div className="xl:block hidden z-[2] left-0 top-0 transition-all duration-500 absolute invisible opacity-0 group-hover:visible group-hover:opacity-100 group-hover:delay-500 w-full h-full">
                                    <div className="top-[50%] -translate-y-[50%] left-0 absolute w-full p-[20px]">
                                        <Swiper slidesPerView={2} spaceBetween={20} loop breakpoints={{
                                            1024: {
                                                slidesPerView: 2
                                            }, 1: {
                                                slidesPerView: 1
                                            ...
                                            <SwiperSlide><Link href={'#'}><Image alt="نمونه کار" src={RandomImage.src} width={1000} height={1000} className="w-full lg:h-[200px] h-[150px] rounded-[20px] object-cover" /></Link></SwiperSlide>
                                            <SwiperSlide><Link href={'#'}><Image alt="نمونه کار" src={RandomImage.src} width={1000} height={1000} className="w-full lg:h-[200px] h-[150px] rounded-[20px] object-cover" /></Link></SwiperSlide>
                                            <SwiperSlide><Link href={'#'}><Image alt="نمونه کار" src={RandomImage.src} width={1000} height={1000} className="w-full lg:h-[200px] h-[150px] rounded-[20px] object-cover" /></Link></SwiperSlide>
                                            <SwiperSlide><Link href={'#'}><Image alt="نمونه کار" src={RandomImage.src} width={1000} height={1000} className="w-full lg:h-[200px] h-[150px] rounded-[20px] object-cover" /></Link></SwiperSlide>
                                            <SwiperSlide><Link href={'#'}><Image alt="نمونه کار" src={RandomImage.src} width={1000} height={1000} className="w-full lg:h-[200px] h-[150px] rounded-[20px] object-cover" /></Link></SwiperSlide>
                                        ...
                                        <Link className="btn-primary mt-[20px] w-full" href={'/work-samples'}>
                                            نمونه کار ها
                                            <IconComponent name="chevron-left" size={16} />
                                        </Link>
                                    </div>
