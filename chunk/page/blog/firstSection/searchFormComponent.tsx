...
export default function SearchFormComponent({ name, placeHolder }: propsType):ReactNode {
    ...
    // Returninng JSX
    return (
        <form action='#' data-focused={isFocused} className="lg:w-[50%] w-full transition-all duration-500 flex items-center justify-between rounded-[18px] border-[1.5px] data-[focused='false']:border-lightGrey data-[focused='true']:border-dark overflow-hidden">
