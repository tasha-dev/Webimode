...
export default function StepComponent({children, icon, isActive, title, position, count}:propsType):ReactNode {
    ...
    return (
        <div className="step-component" data-active={isActive} data-position={position}>
            <div className="lg:block lg:px-0 lg:py-0 px-[16px] py-[12px] lg:rounded-0 rounded-[16px] lg:bg-transparent data-[active='false']:bg-lighterGrey data-[active='true']:bg-theme flex items-center justify-between gap-[20px]" data-active={isActive} data-position={position}>
                ...
                <div className="lg:w-auto lg:flex justify-center items-center">
