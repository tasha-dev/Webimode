    ...
    return (
        <div data-liked={isCommentLiked} className='p-[24px] rounded-[32px] transition-all duration-500 border data-[liked="false"]:border-lightGrey data-[liked="true"]:border-theme'>
            ...
            <div data-showing={isCommentShowing} className="transition-all duration-500 data-[showing='false']:invisible data-[showing='false']:h-0 data-[showing='true']:visible data-[showing='true']:h-auto data-[showing='false']:opacity-0 data-[showing='true']:opacity-100">
                <div className="w-full h-[2px] bg-gradient-to-r from-transparent to-transparent transition-all duration-500 via-lightGrey mb-[16px]" />   
                <form action={'#'} className="flex items-end gap-[20px] bg-lighterGrey border border-lightGrey rounded-[16px] overflow-hidden">
                    <textarea name="comment" id="comment-input" placeholder="پاسخ خود را بنویسید" className="p-[12px] w-full bg-transparent h-[92px] outline-none resize-none placeholder:text-[13px] placeholder:text-lightGrey text-[13px] text-dark"/>
