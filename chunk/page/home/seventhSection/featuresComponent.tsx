    ...
    return (
        <div data-active={isActive} data-position={position} className="data-[position='bottom']:lg:mt-[120px]">
            ...
            <div className="relative lg:block flex items-center justify-center">
                <svg data-active={isActive} className="data-[active='true']:text-theme transition-all duration-500 data-[active='false']:text-lightGrey lg:w-full w-[50%]" viewBox="0 0 214 291" fill="none" xmlns="http://www.w3.org/2000/svg">
