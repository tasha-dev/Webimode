...
export default function HeaderComponent():ReactNode {
    ...
    const dashboardPages:Array<string> = ['/dashboard', '/dashboard/notifications', '/dashboard/tickets', '/dashboard/payments', '/dashboard/faq', '/dashboard/profile', '/dashboard/projects', '/dashboard/faq'];
