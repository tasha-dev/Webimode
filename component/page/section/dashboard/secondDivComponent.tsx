        ...
        <div className="grid lg:grid-cols-2 gap-[32px]">
            <div>
                <div className="flex items-center justify-between gap-[10px] mb-[26px]">
                    <span className="text-[20px] font-normal text-dark block truncate">اطلاعات حساب کاربری</span>
                ...
                <div className="lg:h-[300px] bg-lighterGrey rounded-[32px] lg:overflow-auto px-[25px] py-[14px]">
                    <form action="#" className="grid lg:grid-cols-2 gap-x-[23px] gap-y-[32px]">
            ...
            <div>
                <div className="flex items-center justify-between gap-[10px] mb-[26px]">
                    <span className="text-[20px] font-normal text-dark block truncate">پیام های من</span>
                    <div className="lg:hidden block">
                        <Link href={'/dashboard/profile'} className="btn-secondary-theme-icon">
                            <IconComponent name="chevron-left" size={10} />
                        </Link>
                ...
                <div className="h-[300px] bg-lighterGrey rounded-[32px] pr-[25px] py-[14px] flex flex-col relative overflow-hidden">
