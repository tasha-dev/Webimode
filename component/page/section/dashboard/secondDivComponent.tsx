    ...
    return (
        <div className="grid lg:grid-cols-2 gap-[32px]">
            <div>
                ...
                <div className="lg:h-[300px] dark:bg-pageDark bg-lighterGrey rounded-[32px] lg:overflow-auto px-[25px] py-[14px]">
            ...
            <div>
                ...
                <div className="h-[300px] bg-lighterGrey dark:bg-pageDark rounded-[32px] pr-[25px] py-[14px] flex flex-col relative overflow-hidden">
