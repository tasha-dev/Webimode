...
export default function ThirdDivComponent():ReactNode {
    ...
    return (
        <div>
            ...
            <div className="p-[32px] border border-lighterGrey rounde-[48px] grid lg:grid-cols-3 rounded-[48px]">
                <div className="lg:col-span-2 lg:pb-[32px] pb-[32px] lg:px-[20px]">
                    <span className="text-[20px] font-normal text-dark block truncate mb-[32px]">پروژه طراحی سایت فروشگاهی آفلند</span>
