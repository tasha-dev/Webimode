...
export default function MiddleSideComponent():ReactNode {
    ...
    return (
        <div className="col-span-3 bg-dark h-[100vh] grid grid-cols-1 grid-rows-6">
            <div className="overflow-x-auto overflow-y-hidden flex gap-[24px] items-center justify-center row-span-1 p-[32px] no-scroll">
            ...
            <div className="flex items-center justify-center col-span-1 row-span-4 overflow-x-hidden overflow-y-auto p-[32px] no-scroll">
            ...
            <div className="col-span-1 row-span-1 p-[32px] flex flex-col items-center justify-center">
