...
export default function MiddleSideComponent():ReactNode {
    // Returning JSX
    return (
        <div className="lg:col-span-3 bg-dark lg:grid grid-cols-1 lg:grid-rows-6 lg:h-scren h-auto">
            <div className="overflow-x-auto overflow-y-hidden flex gap-[24px] items-center justify-center lg:row-span-1 p-[20px] no-scroll">
            ...
            <div className="flex items-center lg:justify-center justify-start col-span-1 lg:row-span-4 overflow-x-hidden overflow-y-auto p-[20px] no-scroll">
            ...
            <div className="lg:col-span-1 lg:row-span-1 p-[20px] flex items-end">
                <form action="#" className="bg-pageDark border border-lightestDark rounded-[12px] shadow-black flex w-full items-center overflow-hidden" dir="ltr">
