...
// Creating and exporting nineth section of work samples page as defaultt
export default function FifthSectionComponent():ReactNode {
    ...
    // Returning JSX 
    return (
        <section className="py-[64px] lg:mt-[249px] mt-[149px] lg:mb-[161px] mb-[129px] bg-gradient-to-r from-themeBlue to-darketThemeBlue">
                ...
                <header className="flex items-center lg:justify-between justify-center gap-[10px] flex-wrap lg:mb-[44px] mb-[24px]">
                    ...
                    <div className="lg:flex hidden items-center gap-[24px]">
                        <button 
                            ...
                            id="work-9-section-slider-prev-btn" 
                        ...
                        <button 
                            ...
                            id="work-9-section-slider-next-btn" 
                            className="slider-prev-next-btn-blue"
                        >
                ...
                <main>
                    <div className="lg:block hidden">
                        <Swiper
                            ...
                            slidesPerView={4}
                            navigation={{
                                prevEl: '#work-9-section-slider-prev-btn',
                                nextEl: '#work-9-section-slider-next-btn'
                            }}
                        >
                    ...
                    <div className="lg:hidden block">
                        <Swiper
                            ...
                            slidesPerView={1}
                            navigation={{
                                prevEl: '#work-9-section-slider-prev-btn-mq',
                                nextEl: '#work-9-section-slider-next-btn-mq'
                            }}
                        >
                        ...
                        <SliderPaginationComponent 
                            hasButtons 
                            prevBtnId="work-9-section-slider-prev-btn-mq" 
                            nextBtnId="work-9-section-slider-next-btn-mq" 
                            theme="white" 
