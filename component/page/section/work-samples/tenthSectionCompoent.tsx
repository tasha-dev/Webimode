...
export default function EighthSectionComponent():ReactNode {
    ...
    // Returning JSX 
    return (
        <section className="lg:mt-[249px] mt-[50px] lg:mb-[80px] mb-[50px]">
                ...
                <header className="flex items-center lg:justify-between justify-center gap-[10px] flex-wrap lg:mb-[44px] mb-[24px]">
                    ...
                    <div className="lg:flex hidden items-center gap-[24px]">
                        <button 
                            ...
                            id="work-10-section-slider-prev-btn" 
                        ...
                        <button 
                            ...
                            id="work-10-section-slider-next-btn" 
                            className="slider-prev-next-btn"
                        >
                ...
                <main>
                    <div className="lg:block hidden">
                        <Swiper
                            ...
                            slidesPerView={4}
                            navigation={{
                                prevEl: '#work-10-section-slider-prev-btn',
                                nextEl: '#work-10-section-slider-next-btn'
                            }}
                        >
                    ...
                    <div className="lg:hidden block">
                        <Swiper
                            ...
                            slidesPerView={1}
                            navigation={{
                                prevEl: '#work-10-section-slider-prev-btn-mq',
                                nextEl: '#work-10-section-slider-next-btn-mq'
                            }}
                        >
                            <SwiperSlide><ProjectComponent theme="theme" img={ProjectImage.src} link="#" minPrice={2450000} maxPrice={7100000} rating={4.5} title="سایت فروشگاهی آترامارت">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است .</ProjectComponent></SwiperSlide>
                            <SwiperSlide><ProjectComponent theme="theme" img={ProjectImage.src} link="#" minPrice={2450000} maxPrice={7100000} rating={4.5} title="سایت فروشگاهی آترامارت">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است .</ProjectComponent></SwiperSlide>
                        ...
                        <SliderPaginationComponent 
                            swiper={sliderMQ}
                            hasButtons 
                            prevBtnId="work-10-section-slider-prev-btn-mq" 
                            nextBtnId="work-10-section-slider-next-btn-mq" 
