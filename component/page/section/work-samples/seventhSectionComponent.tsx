...
// Creating and exporting seventh section of work samples page as defaultt
export default function SeventhSectionComponent():ReactNode {
    ...
    // Returning JSX 
    return (
        <section className="lg:py-[64px] lg:mt-[249px] mt-[50px] lg:mb-[161px] mb-[50px] bg-gradient-to-r from-themeRed to-orange">
                ...
                <header className="flex items-center lg:justify-between justify-center gap-[10px] flex-wrap lg:mb-[44px] mb-[24px]">
                    ...
                    <div className="lg:flex hidden items-center gap-[24px]">
                        <button 
                            ...
                            id="work-7-section-slider-prev-btn" 
                        ...
                        <button 
                            ...
                            id="work-7-section-slider-next-btn" 
                            className="slider-prev-next-btn-blue"
                        >
                ...
                <main>
                    <div className="lg:block hidden">
                        <Swiper
                            ...
                            slidesPerView={4}
                            navigation={{
                                prevEl: '#work-7-section-slider-prev-btn',
                                nextEl: '#work-7-section-slider-next-btn'
                            }}
                        >
                            <SwiperSlide><ProjectComponent ratingTheme="red" theme="white" img={ProjectImage.src} link="#" minPrice={2450000} maxPrice={7100000} rating={4.5} title="سایت فروشگاهی آترامارت">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است .</ProjectComponent></SwiperSlide>
                            <SwiperSlide><ProjectComponent ratingTheme="red" theme="white" img={ProjectImage.src} link="#" minPrice={2450000} maxPrice={7100000} rating={4.5} title="سایت فروشگاهی آترامارت">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است .</ProjectComponent></SwiperSlide>
                            <SwiperSlide><ProjectComponent ratingTheme="red" theme="white" img={ProjectImage.src} link="#" minPrice={2450000} maxPrice={7100000} rating={4.5} title="سایت فروشگاهی آترامارت">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است .</ProjectComponent></SwiperSlide>
                            <SwiperSlide><ProjectComponent ratingTheme="red" theme="white" img={ProjectImage.src} link="#" minPrice={2450000} maxPrice={7100000} rating={4.5} title="سایت فروشگاهی آترامارت">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است .</ProjectComponent></SwiperSlide>
                            <SwiperSlide><ProjectComponent ratingTheme="red" theme="white" img={ProjectImage.src} link="#" minPrice={2450000} maxPrice={7100000} rating={4.5} title="سایت فروشگاهی آترامارت">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است .</ProjectComponent></SwiperSlide>
                        ...
                        <SliderPaginationComponent swiper={slider} theme="white" activeIndex={activeSliderIndex} slidesPerView={4} slidesCount={5} />
                    </div>
                    <div className="lg:hidden block">
                        <Swiper
                            ...
                            slidesPerView={1}
                            navigation={{
                                prevEl: '#work-7-section-slider-prev-btn-mq',
                                nextEl: '#work-7-section-slider-next-btn-mq'
                            }}
                        >
                        ...
                        <SliderPaginationComponent 
                            swiper={sliderMQ}
                            hasButtons 
                            prevBtnId="work-7-section-slider-prev-btn-mq" 
                            nextBtnId="work-7-section-slider-next-btn-mq" 
                            theme="white" 
