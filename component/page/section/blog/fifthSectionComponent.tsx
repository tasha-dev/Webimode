                ...
                <main>
                    <div className="xl:block hidden">
                        ...
                        <SliderPaginationComponent 
                            swiper={slider}
                            hasButtons 
                            nextBtnId="hot-blogs-fifth-section-next-slide-btn" 
                            prevBtnId="hot-blogs-fifth-section-prev-slide-btn" 
                            slidesPerView={1} 
                            slidesCount={5} 
                    ...
                    <div className="xl:hidden lg:block hidden">
                        ...
                        <SliderPaginationComponent 
                            swiper={sliderXL}
                            hasButtons
                            nextBtnId="hot-blogs-fifth-section-next-slide-btn-xl" 
                            prevBtnId="hot-blogs-fifth-section-prev-slide-btn-xl" 
                            slidesPerView={1}
                            slidesCount={5} 
                    ...
                    <div className="lg:hidden block">
                        ...
                        <SliderPaginationComponent 
                            swiper={sliderLG}
                            hasButtons 
                            nextBtnId="hot-blogs-fifth-section-next-slide-btn-lg" 
                            prevBtnId="hot-blogs-fifth-section-prev-slide-btn-lg" 
                            slidesPerView={1} 
                            slidesCount={5} 
