                ...
                <main>
                    <div className="xl:block hidden">
                        ...
                        <SliderPaginationComponent 
                            ...
                            theme="white"
                            hasButtons
                            nextBtnId="hot-blogs6-next-slide-btn" 
                            prevBtnId="hot-blogs6-prev-slide-btn" 
                            slidesPerView={1} 
                            slidesCount={5} 
                    ...
                    <div className="xl:hidden lg:block hidden">
                        ...
                        <SliderPaginationComponent 
                            ...
                            theme="white" 
                            hasButtons
                            nextBtnId="hot-blogs6-next-slide-btn-xl" 
                            prevBtnId="hot-blogs6-prev-slide-btn-xl" 
                            slidesPerView={1} 
                            slidesCount={5} 
                    ...
                    <div className="lg:hidden block">
                        ...
                        <SliderPaginationComponent 
                            ...
                            theme="white"
                            hasButtons
                            nextBtnId="hot-blogs6-next-slide-btn-lg" 
                            prevBtnId="hot-blogs6-prev-slide-btn-lg" 
                            slidesPerView={1} 
                            slidesCount={5} 
