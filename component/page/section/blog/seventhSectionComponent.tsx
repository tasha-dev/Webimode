                ...
                <main>
                    <div className="xl:block hidden">
                        ...
                        <SliderPaginationComponent 
                            swiper={slider}
                            hasButtons 
                            nextBtnId="most-viewed-blogs-next-slide-btn" 
                            prevBtnId="most-viewed-blogs-prev-slide-btn" 
                            slidesPerView={1} 
                            slidesCount={5} 
                    ...
                    <div className="xl:hidden lg:block hidden">
                        ...
                        <SliderPaginationComponent 
                            hasButtons 
                            swiper={sliderXL}
                            nextBtnId="most-viewed-blogs-next-slide-btn-xl" 
                            prevBtnId="most-viewed-blogs-prev-slide-btn-xl" 
                            slidesPerView={1} 
                            slidesCount={5} 
                    ...
                    <div className="lg:hidden block">
                        ...
                        <SliderPaginationComponent 
                            swiper={sliderLG}
                            hasButtons 
                            nextBtnId="most-viewed-blogs-next-slide-btn-lg" 
                            prevBtnId="most-viewed-blogs-prev-slide-btn-lg" 
                            slidesPerView={1} 
                            slidesCount={5} 
