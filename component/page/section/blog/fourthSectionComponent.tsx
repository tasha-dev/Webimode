            ...
            <div className="container px-[20px] py-[60px]">
                ...
                <main>
                    <div className="xl:block hidden">
                        ...
                        <SliderPaginationComponent theme="white" hasButtons nextBtnId="hot-blogs-next-slide-btn" prevBtnId="hot-blogs-prev-slide-btn" slidesPerView={1} slidesCount={5} activeIndex={activeIndexOfSlider} />
                    </div>
                    <div className="xl:hidden lg:block hidden">
                        ...
                        <SliderPaginationComponent theme="white" hasButtons nextBtnId="hot-blogs-next-slide-btn-xl" prevBtnId="hot-blogs-prev-slide-btn-xl" slidesPerView={1} slidesCount={5} activeIndex={activeIndexOfSliderXL} />
                    </div>
                    <div className="lg:hidden block">
                        ...
                        <SliderPaginationComponent theme="white" hasButtons nextBtnId="hot-blogs-next-slide-btn-lg" prevBtnId="hot-blogs-prev-slide-btn-lg" slidesPerView={1} slidesCount={5} activeIndex={activeIndexOfSliderLG} />
                    </div>
                </main>
            </div>
        </section>
