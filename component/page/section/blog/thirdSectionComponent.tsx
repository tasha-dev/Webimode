            ...
            <div className="container p-[20px]">
                ...
                <main>
                    ...
                    <div className="xl:hidden lg:block hidden">
                        ...
                        <SliderPaginationComponent hasButtons nextBtnId="hot-blogs-next-slide-btn-xl" prevBtnId="hot-blogs-prev-slide-btn-xl" slidesPerView={1} slidesCount={5} activeIndex={activeIndexOfSliderXL} />
                    </div>
                    <div className="lg:hidden block">
                        ...
                        <SliderPaginationComponent hasButtons nextBtnId="hot-blogs-next-slide-btn-lg" prevBtnId="hot-blogs-prev-slide-btn-lg" slidesPerView={1} slidesCount={5} activeIndex={activeIndexOfSliderLG} />
                    </div>
                </main>
            </div>
        </section>
