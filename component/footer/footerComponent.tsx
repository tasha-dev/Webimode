...
export default function FooterComponent():ReactNode {
    ...
    const noContactComponentURL:Array<string> = ['/sign-in', '/log-in', '/estimate', '/chat-gpt', '/request-project', '/dashboard', '/dashboard/notifications', '/dashboard/payments', '/dashboard/faq', '/dashboard/profile', '/dashboard/projects'];
    const noMarginTopPages:Array<string> = ['/estimate', '/chat-gpt', '/dashboard', '/dashboard/notifications', '/dashboard/payments', '/dashboard/faq', '/dashboard/profile', '/dashboard/projects'];
